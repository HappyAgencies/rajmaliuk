    ...
    <div className={styles.heroTwoColumns}>
      <div className={styles.left_colum_father}>
        <div className={styles.heroText}>
          ...
          <a className={`${Mont.className} ${styles.buttonMobile}`} href="">
            Schedule a consultation
          </a>
        </div>
        <div className={styles.heroParagraph}>
          <p className={`${styles.ariel} ${allura.className}`}>
            Ariel Rajmaliuk
          </p>
          <p className={`${styles.heroSubtitle} ${Mont.className}`}>
            CEO @happyagancies & Fractional <span className={styles.cto}>CTO/CMO</span>
          </p>
        </div>

        {/* Carrusel solo en dispositivos móviles */}
        <div className={`${styles.partners} ${styles.mobileOnly}`}>
        ...
        {/* En escritorio, se muestran las imágenes estáticas */}
        <div className={`${styles.partners} ${styles.desktopOnly}`}>
          <Image src="/assets/imgs/upwork.png" width={122} height={43} alt="Upwork" />
          <Image src="/assets/imgs/clutch.png" width={100} height={25} alt="Clutch" />
          <Image src="/assets/imgs/hubSpot.png" width={110} height={38} alt="HubSpot" />
          <Image src="/assets/imgs/googlePartner.png" width={83} height={34} alt="Google Partner" />
      ...
      <div className={styles.imageFather}>
        <Image src="/assets/imgs/man.png" width={709} height={877} alt="Person" />
      </div>
    </div>
  );
};
