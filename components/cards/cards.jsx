  ...
  return (
    <div className="cardsSection">
      <div className={styles.cardSectionTitle}>
        ...
        <h2 className={`${Mont.className} ${styles.brands}`}>
          {props.sectiontitle}
        </h2>
      ...
      <div className={styles.cardsContainer}>
        ...
        >
          ...
          <div className={styles.cardBottomRow}>
            <p className={styles.cardText}>{props.card1Paragraph}</p>
          </div>
        </div>
...
*/}
          ...
          <div className={styles.cardBottomRow}>
            <p className={styles.cardText}>{props.card2Paragraph}</p>
